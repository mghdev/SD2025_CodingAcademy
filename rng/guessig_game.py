...
def main():
    ...
    #         Otherwise, add 1 to the guess counter and tell the player if their guess was too low or too high.
    #     At the end, print out the player's score.
    # Second, add the ability to replay the game without restarting the script, as well as a few other commands we will talk about in class.
    #     This will involve nesting the main loop from the original version inside another loop.
    #     We will talk about how to organize the code to make it easier.
